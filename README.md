# Administrative Data Coverage Index

One of the three Empstat labour-data coverage indices. This repo is self-contained
and deploys to **https://admin.empstat.org** via GitHub Pages.

- Site: `web/index.html` (reads `web/data/rankings.js`)
- Custom domain: `web/CNAME` = admin.empstat.org
- Pipeline: `pipeline/` — refresh real data with:
  ```
  cd pipeline
  pip install -r requirements.txt
  python fetch_and_rank.py --config config_admin --out ../web/data
  ```
